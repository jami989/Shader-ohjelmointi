    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert (Attributes input)
            {
                ...
                const VertexPositionInputs vertPos = GetVertexPositionInputs(input.positionOS.xyz);
            ...
            half3 SampleOcclusion(const float2 uv) {
                return UnpackNormal(SAMPLE_TEXTURE2D(_OcclusionMap, sampler_OcclusionMap, uv));
            }
