...
namespace Lopputyo
{
    ...
    public class GameOfLife : MonoBehaviour
    {
        ...
        private static readonly int STexSize = Shader.PropertyToID("TexSize");
        private static readonly int SBorderLoop = Shader.PropertyToID("isBorderLoop");
        ...
        [SerializeField] private bool isBorderLoop = true;
        ...
        void Start()
        {
            ...
            lifeSimulator.SetVector(STexSize, (Vector2)TexSize);
            lifeSimulator.SetBool(SBorderLoop, isBorderLoop);
